...
public class OnePerson {
    ...
    public OnePerson() {
        ...
        this.fogOfWar = new char[fieldSize][fieldSize];
        ...
        shipList.add(new Ship("OnePerson", 4));
...
//        System.out.println("Take a shot!");
    ...
    private boolean checkCoordinate(String strCoord) {
...
class Ship {
    ...
    public boolean isHit(Coordinate placeOfShot) {
        if (coordinate.containsCoordinate(placeOfShot)) {
            coordinate.removeCoordinate(placeOfShot);
            return true;
        }
        return false;
    }
